...
public class ClassicValidator implements Validator {
    ...
    public boolean isValid(boolean turn1, Action action, Game game) {
        assert game instanceof Classic;
        if (action instanceof Move) {
            ...
            return isBlockValid((Block) action, (Classic) game);
        }
        return false;
    }
